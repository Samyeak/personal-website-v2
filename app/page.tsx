    ...
    <div className="min-h-screen">
      ...
      <section className="max-w-6xl mx-auto px-6 py-20 lg:py-32">
        <div className="text-center">
          ...
          <p className="text-xl lg:text-2xl text-primary-secondary mb-8 max-w-3xl mx-auto animate-slide-up">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-primary-secondary text-lg mb-6">
                ...
                that bridge the gap between design and technology. I enjoy working on projects
            ...
            <div className="bg-card rounded-2xl p-8 text-center">
              <div className="w-32 h-32 bg-border rounded-full mx-auto mb-4 flex items-center justify-center">
                <span className="text-primary-muted text-sm">Your Photo</span>
              </div>
              <h3 className="text-xl font-medium text-primary mb-2">Your Name</h3>
              <p className="text-primary-secondary">Full Stack Developer</p>
            </div>
          </div>
        </div>
      </section>
